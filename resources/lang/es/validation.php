...
return [
    ...
    */
    ...
    "alpha_dash" =>
        "El campo :attribute solamente puede contener letras, números, guiones y guiones bajos.",
    "alpha_num" =>
        "El campo :attribute solamente puede contener letras y números.",
    ...
    "gte" => [
        ...
        "file" =>
            "El campo :attribute debe ser mayor que or equal :value kilobytes.",
        "string" =>
            "El campo :attribute debe ser mayor que or equal :value caracteres.",
    ...
    "lte" => [
        ...
        "file" =>
            "El campo :attribute must be less than or equal :value kilobytes.",
        "string" =>
            "El campo :attribute must be less than or equal :value caracteres.",
    ...
    "max" => [
        ...
        "string" =>
            "El campo :attribute no debería tener más de :max caracteres.",
        "array" =>
            "El campo :attribute no debería tener más de :max elementos.",
    ],
    ...
    "required_unless" =>
        "El campo :attribute es obligatorio al menos que :other esté en :values.",
    "required_with" =>
    ...
    "required_without_all" =>
        "El campo :attribute es obligatorio cuando ninguno de los valores: :values está presente.",
    ...
    "starts_with" =>
        "El campo :attribute con uno de los siguientes valores: :values",
